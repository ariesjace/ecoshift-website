    ...
    <section className="relative overflow-hidden bg-background px-6 py-24 sm:px-8 md:py-28">
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 text-center">
        <motion.div
          ...
          className="space-y-4"
        >
          <span className="text-xs uppercase tracking-[0.25em] text-foreground/60">Contact</span>
          <h2 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
            Let’s build something exceptional together
          </h2>
          <p className="max-w-2xl text-foreground/70">
            Share your project details and our team will reach out within one business day. We’re here to collaborate
        ...
        <Card className="group relative w-full max-w-4xl overflow-hidden rounded-2xl border border-border/40 bg-background/60 p-0 backdrop-blur transition-all hover:border-border/60 hover:shadow-lg">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-8 text-left text-foreground/70">
              <motion.div
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold tracking-tight text-foreground">Tell us about your project</h3>
                <p className="text-sm text-foreground/70">
                  We’ll schedule a discovery call to understand your goals, timeline, and success metrics. Prefer email?
                  Reach us at{" "}
                  <a
              ...
              <div className="grid gap-4 text-sm text-foreground/70">
                <div className="flex items-start gap-3 rounded-xl border border-border/40 bg-background/40 p-3">
                  <Mail className="mt-0.5 h-4 w-4 text-foreground/60" aria-hidden="true" />
                  <div>
                ...
                <div className="flex items-start gap-3 rounded-xl border border-border/40 bg-background/40 p-3">
                  <Phone className="mt-0.5 h-4 w-4 text-foreground/60" aria-hidden="true" />
                  <div>
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-xs font-semibold uppercase tracking-[0.2em] text-foreground/60">
                    Full Name
                  </Label>
                  <Input
                    id="name"
              ...
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-xs font-semibold uppercase tracking-[0.2em] text-foreground/60">
                  Phone Number
                </Label>
                <div className="relative">
                  <Phone
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <MessageSquare className="absolute left-3 top-3 h-4 w-4 text-foreground/50" aria-hidden="true" />
                  <Textarea
                    id="message"
                    name="message"
