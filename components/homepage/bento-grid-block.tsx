...
const reelStats: ReelStat[] = [{ label: "3:42 min" }, { label: "4.2K views" }, { label: "Dynamic timing curves" }]
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        ...
        >
          ...
          <p className="max-w-2xl text-base text-foreground/70 md:text-lg">
            Pair narrative, metrics, and cinematic visuals inside a responsive layout designed around Framer Motion
            micro-interactions and accessible navigation.
          </p>
        </motion.header>
        ...
        >
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-sm text-foreground/70 md:text-base">
                  We choreograph micro-interactions and depth cues that elevate usability across every product
                  surface-without sacrificing performance or accessibility.
                </p>
              </div>
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-end space-y-4 p-6 md:p-8">
              ...
              <p className="max-w-sm text-sm text-foreground/70 md:text-base">
                Layered light, shadow, and depth cues help teams experience the product as it will ship-well before the
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm text-foreground/70 md:text-base">
                We compress discovery, exploration, and refinement into a focused week-long sprint so your team can feel
                the flow of the final experience sooner.
              </p>
            </div>
              ...
              <div className="relative flex h-full flex-col justify-between bg-gradient-to-br from-background/90 via-background/70 to-transparent p-6 md:p-8">
                <div className="space-y-4">
                  ...
                  <p className="max-w-md text-sm text-foreground/70 md:text-base">
                    A three-minute deep dive into timing curves, coordinated transitions, and how we translate component
                    choreography into production-ready systems.
                  </p>
                </div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-sm text-foreground/70 md:text-base">
                A snapshot of the references that steer our motion language and narrative rhythm, curated for both
